...
//		kuyruk2.add(70);
		...
		System.out.println("for each Yazdırımı"); // Karışık yazdırıyor
		for (Integer integer : kuyruk4) {
			System.out.println(integer);
		}
		
		System.out.println("Kuyruktan Sırayla Yazdırma"); // Sırayla yazdırıyor
		...
		musteriler.offer(new Musteri("Zeliha", 25));
		...
		// Yaşa göre Sıralama Eğer Yaşlar Eşitse İsme Göre Sıralar
